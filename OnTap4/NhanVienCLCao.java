...
public class NhanVienCLCao extends NhanVien{
    ...
    public NhanVienCLCao(String TrinhDo, String Nganh, String NoiDaoTao, double Luong, String NgayNhanViec, String MaPBK, String TenPBK, String Ten, String NamSinh) {
        super(Luong, NgayNhanViec, MaPBK, TenPBK, Ten, NamSinh);
        this.TrinhDo = TrinhDo;
        this.Nganh = Nganh;
        this.NoiDaoTao = NoiDaoTao;
    }
